...
urlpatterns = [
    ...
    url(r'^reportes/devoluciones/revision/$', views.rep_dev_revision,
        name='rep_dev_revision'),
    url(r'^reportes/glosas/revision/$', views.rep_gl_revision,
        name='rep_gl_revision'),
    url(r'^exportar/$', views.exportar, name='exportar'),
    url(r'^reportes/exp_rad_general/$', views.exp_rad_general,
        name='exp_rad_general'),
    url(r'^reportes/exp_gl_general/$', views.exp_gl_general,
        name='exp_gl_general'),
    url(r'^reportes/exp_dev_general/$', views.exp_dev_general,
        name='exp_dev_general'),
