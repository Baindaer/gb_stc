...
urlpatterns = [
    ...
    url(r'^reportes/exp_rad_general/$', views.exp_rad_general, 
        name='exp_rad_general'),
    url(r'^pruebas/$', views.pruebas, name='pruebas'),
    url(r'^devoluciones/remision$', views.dev_remision, name='dev_remision'),
    url(r'^devoluciones/actualizacion$', views.dev_actualizacion, 
        name='dev_actualizacion'),
    ...
    url(r'^glosas/actualizacion/$', views.gl_actualizacion, name='gl_actualizacion'),
    url(r'^glosas/respuestas/$', views.gl_respuestas, name='gl_respuestas'),
    url(r'^glosas/respuestas/imprimir$', views.gl_resp_imp, 
        name='gl_resp_imp'),
    url(r'^glosas/respuestas/agregar$', views.gl_resp_agregar, 
        name='gl_resp_agregar'),
